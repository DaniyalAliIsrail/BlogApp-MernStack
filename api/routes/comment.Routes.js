...
import { createComment, deleteComment, getAllCommentForAdmin, getComment, likeComment, updateComment } from "../controller/commentController.js" 
...
router.get("/getallcommentforAdmin",verifyToken,getAllCommentForAdmin)
